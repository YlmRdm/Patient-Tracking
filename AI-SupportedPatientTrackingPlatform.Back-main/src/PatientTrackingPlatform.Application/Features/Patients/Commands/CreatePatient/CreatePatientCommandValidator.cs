...
namespace PatientTrackingPlatform.Application.Features.Patients.Commands.CreatePatient
{
    public class CreatePatientCommandValidator : AbstractValidator<CreatePatientCommand>
    {
        ...
        public async Task<bool> BeUniqueIdentificationNumber(string identificationNumber, CancellationToken cancellationToken)
        {
            return !await _patientRepository.ExistsWithIdentificationNumberAsync(identificationNumber);
        }
    }
}